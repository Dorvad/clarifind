(() => {
  const i18n = {
    ...
    he: {
      ...
      "hero.visual.card1.label": "ציון בהירות",
      "hero.visual.card1.meta": "שיפור בהבנה אצל לומדים",
      "hero.visual.card2.label": "מעורבות",
      "hero.visual.card2.meta": "השלמה בתוך 30 יום",
